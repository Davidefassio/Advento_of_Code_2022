...
fn wrap_example(pos: (u32, u32), facing: Direction) -> ((u32, u32), Direction) {
    let (row, col) = pos;
    if row >=1 && row <= 4 && col >= 9 && col <= 12 {  // face 1
        if facing == Direction::Right {
            ...
            panic!("wrap_example(): bug: pos=({}, {}), facing={:?}", row, col, facing);
        }
    } else if row >= 5 && row <= 8 && col >= 1 && col <= 4 {  // face 2
    ...
    } else if row >= 5 && row <= 8 && col >= 5 && col <= 8 {  // face 3
        if facing == Direction::Down {
    ...
    } else if row >= 5 && row <= 8 && col >= 9 && col <= 12 {  // face 4
        if facing == Direction::Right {
    ...
    } else if row >= 9 && row <= 12 && col >= 9 && col <= 12 {  // face 5
        if facing == Direction::Down {
    ...
    } else if row >= 13 && row <= 16 && col >= 9 && col <= 12 {  // face 6
        if facing == Direction::Right {
...
fn wrap_input(pos: (u32, u32), facing: Direction) -> ((u32, u32), Direction) {
    let (row, col) = pos;
    if row >=1 && row <= 50 && col >= 51 && col <= 100 {  // face 1
    ...
    } else if row >= 1 && row <= 50 && col >= 101 && col <= 150 {  // face 2
        if facing == Direction::Right {
    ...
    } else if row >= 51 && row <= 100 && col >= 51 && col <= 100 {  // face 3
        if facing == Direction::Right {
    ...
    } else if row >= 101 && row <= 150 && col >= 51 && col <= 100 {  // face 4
        if facing == Direction::Right {
    ...
    } else if row >= 101 && row <= 150 && col >= 1 && col <= 50 {  // face 5
        if facing == Direction::Left {
    ...
    } else if row >= 151 && row <= 200 && col >= 1 && col <= 50 {  // face 6
        if facing == Direction::Right {
